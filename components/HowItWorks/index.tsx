...
import { Wallet, Coins, BarChart, ArrowRight } from 'lucide-react';
    ...
    <section className="relative py-24 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          >
            Live on Sui Testnet with suiBTC. Use your assets as collateral to mint or borrow synthetic tokens and trade in real time.
          </motion.p>
        </div>
